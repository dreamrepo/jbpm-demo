 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://application.jbpm.foreveross.org/}processVO" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetProcessesResponse {
    ...
    protected List<ProcessVO> _return;
     ...
     * 
     */
    public List<ProcessVO> getReturn() {
        if (_return == null) {
            _return = new ArrayList<ProcessVO>();
        }
        return this._return;
    }
