 ...
 ******************************************************************************/
package org.foreveross.jbpm.jbpmDemo.applicationImpl.util;
...
public class FossEntityRepositoryJpa implements EntityRepository {
	...
	public <T extends Entity> T save(T entity) {
		if (entity.getId() == null) {
			...
			LOGGER.info("save a entity: " + entity.getClass() + "/"
					+ entity.getId() + ".");
		} else {
